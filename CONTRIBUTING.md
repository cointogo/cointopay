Contributing to 2PAY Core
============================

The 2PAY Core project operates an open contributor model where anyone is
...
The following applies to code changes to the 2PAY Core project, and is not to be
confused with overall 2PAY Network Protocol consensus changes.

Whether a pull request is merged into 2PAY Core rests with the project merge
...
Patches that change 2PAY consensus rules are considerably more involved than
...
Where a patch set proposes to change the 2PAY consensus, it must have been
...
The project leader is the release manager for each 2PAY Core release.
