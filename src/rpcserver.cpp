...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* 2PAY features */
        {"cointopay", "masternode", &masternode, true, true, false},
        {"cointopay", "listmasternodes", &listmasternodes, true, true, false},
        {"cointopay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cointopay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cointopay", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"cointopay", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"cointopay", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"cointopay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cointopay", "masternodedebug", &masternodedebug, true, true, false},
        {"cointopay", "startmasternode", &startmasternode, true, true, false},
        {"cointopay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cointopay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cointopay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cointopay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cointopay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cointopay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cointopay", "mnbudget", &mnbudget, true, true, false},
        {"cointopay", "preparebudget", &preparebudget, true, true, false},
        {"cointopay", "submitbudget", &submitbudget, true, true, false},
        {"cointopay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cointopay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cointopay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cointopay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cointopay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cointopay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cointopay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cointopay", "checkbudgets", &checkbudgets, true, true, false},
        {"cointopay", "mnsync", &mnsync, true, true, false},
        {"cointopay", "spork", &spork, true, true, false},
        {"cointopay", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> cointopay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:59102/\n";
}
