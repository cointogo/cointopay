...
#ifndef ZIJA_Z2PAYWALLET_H
#define ZIJA_Z2PAYWALLET_H
...
public:
    Cz2PAYWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZ2PAY(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZ2PAY(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //ZIJA_Z2PAYWALLET_H
