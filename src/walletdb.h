...
public:
    ...
    bool WriteZ2PAYSeed(const uint256& hashSeed, const vector<unsigned char>& seed);
    bool ReadZ2PAYSeed(const uint256& hashSeed, vector<unsigned char>& seed);
    bool ReadZ2PAYSeed_deprecated(uint256& seed);
    bool EraseZ2PAYSeed();
    bool EraseZ2PAYSeed_deprecated();

    bool WriteZ2PAYCount(const uint32_t& nCount);
    bool ReadZ2PAYCount(uint32_t& nCount);
