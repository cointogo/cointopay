                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("2PAY Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a 2PAY address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cointopay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About 2PAY Core"), this);
    aboutAction->setStatusTip(tr("Show information about 2PAY Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for 2PAY"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your 2PAY addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified 2PAY addresses"));
    ...
    openAction->setStatusTip(tr("Open a 2PAY: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the 2PAY Core help message to get a list with possible 2PAY command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("2PAY Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to 2PAY network", "", count));
}
...
{
    QString strTitle = tr("2PAY Core"); // default title
