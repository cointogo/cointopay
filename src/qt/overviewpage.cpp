...
class TxViewDelegate : public QAbstractItemDelegate
{
    Q_OBJECT
public:
    TxViewDelegate() : QAbstractItemDelegate(), unit(BitcoinUnits::THE2PAY)
    {
    }
...
void OverviewPage::getPercentage(CAmount nUnlockedBalance, CAmount nZerocoinBalance, QString& s2PAYPercentage, QString& sz2PAYPercentage)
{
    int nPrecision = 2;
    ...
    sz2PAYPercentage = "(" + QLocale(QLocale::system()).toString(dzPercentage, 'f', nPrecision) + " %)";
    s2PAYPercentage = "(" + QLocale(QLocale::system()).toString(dPercentage, 'f', nPrecision) + " %)";
                              ...
                              const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    bool show2PAYAvailable = settingShowAllBalances || pivAvailableBalance != nTotalBalance;
    bool showWatchOnly2PAYAvailable = watchOnlyBalance != nTotalWatchBalance;
    bool show2PAYPending = settingShowAllBalances || unconfirmedBalance != 0;
    bool showWatchOnly2PAYPending = watchUnconfBalance != 0;
    bool show2PAYLocked = settingShowAllBalances || nLockedBalance != 0;
    bool showWatchOnly2PAYLocked = nWatchOnlyLockedBalance != 0;
    bool showImmature = settingShowAllBalances || immatureBalance != 0;
    bool showWatchOnlyImmature = watchImmatureBalance != 0;
    bool showWatchOnly = nTotalWatchBalance != 0;
    bool showz2PAYAvailable = settingShowAllBalances || zerocoinBalance != matureZerocoinBalance;
    bool showz2PAYnconfirmed = settingShowAllBalances || unconfirmedZerocoinBalance != 0;
    bool showz2PAYImmature = settingShowAllBalances || immatureZerocoinBalance != 0;
...
void OverviewPage::setWalletModel(WalletModel* model)
{
    ...
    // update the display unit, to not use the default ("2PAY")
    updateDisplayUnit();
}
