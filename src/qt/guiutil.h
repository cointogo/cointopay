...
/** Utility functions used by the 2PAY Qt UI.
 */
namespace GUIUtil
{
...
// Render 2PAY addresses in monospace font
...
// Parse "cointopay:" URI into recipient object, return true on successful parsing
