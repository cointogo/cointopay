...
/* Cointopay GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "2PAY"
#define QAPP_ORG_DOMAIN "cointopay.io"
#define QAPP_APP_NAME_DEFAULT "2PAY-Qt"
#define QAPP_APP_NAME_TESTNET "2PAY-Qt-testnet"
