...
void FillBlockPayee(CMutableTransaction& txNew, CAmount nFees,
		bool fProofOfStake, bool fZ2PAYStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
	if (!pindexPrev)
		return;
	...
	// } else {
	masternodePayments.FillBlockPayee(txNew, nFees, fProofOfStake, fZ2PAYStake);
	// }
}
...
void CMasternodePayments::FillBlockPayee(CMutableTransaction& txNew,
		int64_t nFees, bool fProofOfStake, bool fZ2PAYStake) {
	CBlockIndex* pindexPrev = chainActive.Tip();
