...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cointopay Core cointopay-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cointopay-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cointopay transaction") + "\n" +
                               "  cointopay-tx [options] -create [commands]   " + _("Create hex-encoded cointopay transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cointopay transaction
