...
In order to support loading of multiple wallets in cointopay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cointopay.cpp.
...
Changes to cointopay.cpp
----------------------
cointopay.cpp is the entry point into cointopay-qt, and as such, will require some minor modifications to provide hooks for
