...
This mechanism has been integrated into Bitcore-Node-2PAY which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/2PAY-Project/insight-api-cointopay#web-socket-api](https://github.com/2PAY-Project/insight-api-cointopay#web-socket-api) 
* API: [https://github.com/2PAY-Project/insight-api-cointopay#swifttx-transactions](https://github.com/2PAY-Project/insight-api-cointopay#swifttx-transactions) 
...
By default, the 2PAY Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the 2PAY Core daemon:
