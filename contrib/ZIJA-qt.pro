...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cointopay-cli.cpp \
           src/cointopay-tx.cpp \
           src/cointopay.cpp \
           src/db.cpp \
           ...
           src/qt/cointopay.cpp \
           src/qt/cointopaystrings.cpp \
...
RESOURCES += src/qt/cointopay.qrc src/qt/cointopay_locale.qrc

TRANSLATIONS += src/qt/locale/cointopay_bg.ts \
                src/qt/locale/cointopay_de.ts \
                src/qt/locale/cointopay_en.ts \
                src/qt/locale/cointopay_es.ts \
                src/qt/locale/cointopay_fi.ts \
                src/qt/locale/cointopay_fr.ts \
                src/qt/locale/cointopay_it.ts \
                src/qt/locale/cointopay_ja.ts \
                src/qt/locale/cointopay_pl.ts \
                src/qt/locale/cointopay_pt.ts \
                src/qt/locale/cointopay_ru.ts \
                src/qt/locale/cointopay_sk.ts \
                src/qt/locale/cointopay_sv.ts \
                src/qt/locale/cointopay_vi.ts \
                src/qt/locale/cointopay_zh_CN.ts \
                src/qt/locale/cointopay_zh_TW.ts
